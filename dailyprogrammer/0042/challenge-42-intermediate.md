...
So in this challenge, we honor the romans. Your task is to write a function that can add together two Roman numerals supplied as strings. Example: roman\_addition("XXVIII", "LXXXII") returns "CX".
...
**Bonus 1**: Write a function that does subtraction. Example: roman\_subtraction("CX", "LXXXII") returns "XXVIII"

**Bonus 2**: Write a function that performs multiplication with Roman numerals, again without ever converting them to regular integers. Example: roman\_multiplication("XVI", "VII") returns "CXII".
