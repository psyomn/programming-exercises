...
The key for the encryption and decryption consists of two parts: first one scrambled version of the cleartext alphabet (i.e. some permutation of "ABCDEFGHIKLMNOPQRSTUVWXYZ0123456789 "), called the _substition key_. Second we need a _transposition key_ which is a just a codeword of some sort.
...
Now, finally, we simply read off the table _column by column_ to get our ciphertext. This is the final result:
